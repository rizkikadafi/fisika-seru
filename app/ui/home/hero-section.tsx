...
function Tagline() {
  return (
    <div className="sm:px-10 mt-[-5rem] sm:mt-[-13rem] md:mt-0 z-10 md:order-1">
      ...
      <Link href="#" className="text-gray-800 bg-blue-400 hover:bg-blue-500 font-medium rounded-md text-sm lg:text-lg mt-5 inline-block px-6 py-3 text-center border-2 border-blue-400">Study Now</Link>
    </div>
  );
}
...
export default function Hero() {
  return (
    <section id="hero" className="pb-20 px-3 lg:px-10">
